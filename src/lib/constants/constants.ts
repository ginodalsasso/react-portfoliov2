...
export const projects: Project[] = [
    ...
    },
    {
        ...
        icon: githubIcon,
        title: "Flooze",
        description: "[in development] Personal and professional financial management platform built with Symfony. Centralizes tax obligations, expense tracking, invoicing, rental properties, and investment portfolios, with AI-powered receipt OCR via Ollama.",
        image: myGithub,
        href: "https://github.com/ginodalsasso/sf-flooze",
        tags: ["Symfony", "JavaScript", "MySQL", "Ollama", "Docker", "FrankenPHP"],
    },
    {
        id: 4,
        icon: githubIcon,
